...
You can download the [**_R_**](vignettes/datatable.way.R) code and the [**_R Markdown_**](vignettes/datatable.way.Rmd) document of this tutorial.
...
## Assignment
 - Using basic exploratory analyses, find out which counties and which states have passed their COVID-19 peak.
 - 
 
Hint:You can obtain tha main dataset from [this link](https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv)
...
download.file(url = covid19_url, destfile = basename(covid19_url))

covid <- fread(basename(covid19_url))
